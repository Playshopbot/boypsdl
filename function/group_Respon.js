...
const hasilRemove = `https://saipulanuar.ga/api/canvas/goodbye4?name=@${num.split("@")[0]}&gcname=${metadata.subject}&pp=${ppuser}&bg=https://t-2.tstatic.net/lampung/foto/bank/images/arti-mimpi-berjalan-di-hutan-pertanda-diri-sedang-cemas.jpg&apikey=jPHjZpQF` 
await conn.sendMessage(
update.id, 
{
caption: `*Sayonara @${num.split("@")[0]}*\n*kalo mau balik lagi ke group ini, wajib bawa gorengan 1 truk😊*`,
image: {url:hasilRemove},
buttons: button,
...
const hasilWelcome = `https://saipulanuar.ga/api/canvas/welcome4?name=@${num.split("@")[0]}&gcname=${metadata.subject}&pp=${ppuser}&bg=https://t-2.tstatic.net/lampung/foto/bank/images/arti-mimpi-berjalan-di-hutan-pertanda-diri-sedang-cemas.jpg&apikey=jPHjZpQF` 
await conn.sendMessage(
update.id, 
{ 
caption: `*Hello @${num.split("@")[0]}*\n*Welcome to ${metadata.subject}* \n\n*Jangan Lupa Intro*\n*Nama:*\n*Umur:*\n*Hobi:*\n*Askot:*\n\n*Sering² Baca Deskripsi Ya Kak🙏*`,
image: {url:hasilWelcome},
buttons: button, 
footer: metadata.subject,
mentions: [num] })
}
